...
class ExpressHandler {
  constructor() {
    ...
    this.getSurveyQuestionshandler = this.getSurveyQuestionshandler.bind(this);
  }

  async getSurveyQuestionshandler(req, res) {
    const correlationId = req.correlationId();
    const logger = new Logger(correlationId, 'getSurveyQuestionshandler-expressHandler', 'getSurveyQuestionshandler');
    logger.info('Entry');
    try {
      const correlationId = req.correlationId();
      let handlerRes = await this.survey.getSurveyQuestions(req.query.surveyId, correlationId);
